...
function printReport() {
    try {
        ...
        const ciudadLabel = ciudadSelect && ciudadSelect.value ? ciudadSelect.selectedOptions[0].text : 'Todas';
        const agenciaLabel = agenciaSelect && agenciaSelect.value ? agenciaSelect.selectedOptions[0].text : 'Todas';
